  ...
  return (
    ...
    <section className="w-full bg-white py-24">
      <div className="max-w-7xl mx-auto px-6">
        {/* Heading */}
        <div className="mb-16 ml-30 max-w-xl">
        ...
        {/* Cards Wrapper */}
        <div className="relative flex flex-col lg:flex-row items-center lg:items-center ml-30">
          {/* Left Orange Card */}
          ...
          {/* Right Form Card */}
         <div className="lg:w-[42%] bg-white rounded-xl shadow-2xl p-8 -mt-6 min-h-[260px]
                          lg:-ml-10">
